...
import static com.telenav.periodic.metrics.SampleProbability.MaskBits.FIVE;
import static com.telenav.periodic.metrics.SampleProbability.MaskBits.FOUR;
import static com.telenav.periodic.metrics.SampleProbability.MaskBits.ONE;
import static com.telenav.periodic.metrics.SampleProbability.MaskBits.SEVEN;
import static com.telenav.periodic.metrics.SampleProbability.MaskBits.SIX;
import static com.telenav.periodic.metrics.SampleProbability.MaskBits.THREE;
import static com.telenav.periodic.metrics.SampleProbability.MaskBits.TWO;
 ...
 * 
 * The methods providing a <code>BooleanSupplier</code> have overloads which take
 * a <code>Random</code>.  These overloads are for use in tests where deterministic
 * output is required - do not use them in production code, as <code>Random</code>
 * inherently has performance issues in multi-threaded code - if none is provided,
 * then <code>ThreadLocalRandom.current()</code> is used, which is appropriate for
...
public enum SampleProbability {
     ...
     * @return A BooleanSupplier
     */
    public BooleanSupplier supplier(int expectedSamples, @Nullable Random rnd) {
