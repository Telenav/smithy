...
import static com.telenav.smithy.java.generators.builtin.EnumModelGenerator.StringDefaultStatus.ALL;
import static com.telenav.smithy.java.generators.builtin.EnumModelGenerator.StringDefaultStatus.NONE;
import static com.telenav.smithy.java.generators.builtin.EnumModelGenerator.StringDefaultStatus.SOME;
...
final class EnumModelGenerator extends AbstractJavaGenerator<EnumShape> {
    ...
    protected void generate(Consumer<ClassBuilder<String>> cs) {
        ...
        Registry.applyGeneratedAnnotation(EnumModelGenerator.class, cb);
